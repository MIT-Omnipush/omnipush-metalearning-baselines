# Copied from https://github.com/soobinseo/Attentive-Neural-Process/blob/master/network.py
# Minor changed based on https://github.com/deepmind/neural-processes
import torch as t
